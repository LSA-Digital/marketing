...
```mermaid
flowchart TD
    A[Tennessee anchor story] --> B[Academic credibility via Thad]
    B --> C[Warm outreach to state and public-health buyers]
    C --> D[Discovery and education]
    D --> E[Pilot or planning engagement]
    E --> F[License plus state-first configuration]
    F --> G[Recurring advisory and expansion]

    H[Squawk posts and HeyGen videos] --> C
    I[Intern research and calls] --> C
```
...
```mermaid
gantt
    title HSRA 2026 milestones
    dateFormat  YYYY-MM-DD
    axisFormat  %b
    section Market entry
    Tennessee proof package                :a1, 2026-03-10, 45d
    All-state launch and first-touch wave  :a2, 2026-03-17, 60d
    section Conversion
    Webinar and briefing cadence           :b1, 2026-04-15, 244d
    Pilot and proposal cycle               :b2, 2026-04-15, 230d
    section Outcomes
    First anchor close target              :c1, 2026-10-01, 60d
    Reference packaging                    :c2, 2026-10-15, 77d
```
