...
```mermaid
flowchart LR
    A[MEDICODAX proof package and demo] --> B[Warm operator or investor outreach]
    B --> C[Discovery and buyer-fit call]
    C --> D[Technical and commercial diligence]
    D --> E[Transaction or investment structure]
    E --> F[Continuation development agreement]
...
```mermaid
gantt
    title MEDICODAX wholesale 2026 marketing and sales execution
    dateFormat  YYYY-MM-DD
    axisFormat  %b

    section Foundation
    Asset packaging and scorecard setup            :a1, 2026-03-10, 28d
    Proof package and buyer brief                  :a2, 2026-03-15, 45d

    section Outreach
    Wave 1 operator outreach                       :b1, 2026-04-01, 91d
    Wave 2 strategic platform outreach             :b2, 2026-07-01, 92d
    Wave 3 capital and close motion                :b3, 2026-10-01, 75d

    section Content
    Wholesale support campaign                     :c1, 2026-03-20, 286d
    Buyer-brief and narrated asset series          :c2, 2026-04-01, 260d
    Monthly diligence / briefing refresh           :c3, 2026-04-15, 245d

    section Revenue conversion
    Diligence and demo cycle                       :d1, 2026-05-01, 214d
    Transaction and negotiation cycle              :d2, 2026-07-15, 169d
    Continuation agreement packaging               :d3, 2026-09-15, 107d
```
