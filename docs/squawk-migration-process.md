...
| 6 | Do not touch | Repost By, Doc Status, Critical, Posts, Published count, Updated |
| 7 | Title linkification | Use Source Paths to make Title a clickable link to the post markdown file |
| 8 | Drop | Target Platforms — no longer tracked |
