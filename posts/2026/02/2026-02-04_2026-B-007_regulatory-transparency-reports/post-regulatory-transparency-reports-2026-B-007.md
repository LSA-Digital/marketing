...
- What we can say safely:
  ...
  - Reports are designed to be available for different contexts in the workflow (not a single static output).
...
- Repost kit:
  ...
  - Partner voice caption: If you want trust, ship the evidence, not just the output.
- UTM:
  - `utm_source=linkedin`
  - `utm_medium=organic`
