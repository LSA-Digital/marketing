...
We built a layered, API-first microservice architecture so health-risk + community-impact workflows can scale *without* turning into an un-auditable monolith.
