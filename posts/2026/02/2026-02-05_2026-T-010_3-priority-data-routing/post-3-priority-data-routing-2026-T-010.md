...
- **P3 (Research Agent)**: Only when P1 and P2 are insufficient does a separate research model invoke tools (e..g, web search, LSARS HRA disease impact lookups / pollutant database).
