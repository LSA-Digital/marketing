# How does Smart Mobility reduce parking spillover and quality-of-life opposition near project sites?
...
If neighborhoods experience months of disruption with no clear enforcement, the opposition hardens and the permit timeline stretches.
...
**How it works:**
- **Rules + enforcement**: define on-street and off-street rules (including resident/visitor/contractor permits) that can actually be enforced.
...
## Citations / Sources
- https://www.austintexas.gov/department/residential-permit-parking (Example: Residential Permit Parking program to address non-resident spillover)
- https://www.openmobilityfoundation.org/announcing-curb-data-specification-version-1-0/ (Open standard for describing curb/parking policy and data)
