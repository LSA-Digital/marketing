# How does LSARS prevent rework when utility plans change mid-permit?
...
- **Impact-aware deltas**: when an input changes, show what changed and which permits/sections/exhibits are affected.
- **Reviewer-ready re-packaging**: regenerate the affected summaries with citations back to updated sources so reviewers can verify quickly.

**Result:** fewer restarts, fewer "please resubmit" cycles, and changes that are explainable instead of suspicious.

If you want to pressure-test your permit stack and your change-control plan, book a working session at https://lsars.com.
